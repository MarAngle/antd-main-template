...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      // dashboard
      {
        ...
        redirect: '/list/home',
        component: RouteView,
        meta: { title: '列表管理', keepAlive: true, icon: bxAnaalyse, permission: ['dashboard'] },
        children: [
          {
            path: '/list/home',
            name: 'ListHome',
      ...
      },
      {
        ...
        redirect: '/tree/home',
        component: RouteView,
        meta: { title: '树形管理', keepAlive: true, icon: bxAnaalyse, permission: ['dashboard'] },
        children: [
          {
            path: '/tree/home',
            name: 'TreeHome',
            component: () => import('@/mainpage/tree/home/index'),
      ...
      },
      {
        ...
        component: RouteView,
        meta: { title: '类说明', keepAlive: true, icon: bxAnaalyse, permission: ['dashboard'] },
        children: [
          {
